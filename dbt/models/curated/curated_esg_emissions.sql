...
WITH nzdpu_emissions AS (
    SELECT
        ...
        {{ to_decimal('scope_1_tco2e') }}               AS scope_1_tco2e,
        {{ to_decimal('scope_2_location_tco2e') }}      AS scope_2_location_tco2e,
        {{ to_decimal('scope_2_market_tco2e') }}        AS scope_2_market_tco2e,
        {{ to_decimal('scope_3_total_tco2e') }}         AS scope_3_total_tco2e,
